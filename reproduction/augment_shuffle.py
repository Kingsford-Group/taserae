...
def main():
    parser = argparse.ArgumentParser(description="Augment data using Shuffle method")
    ...
    augment_utils.save_augmented_data(train_df, augmented_rows, "shuffle", args.strategy)
